...
<style>
	...
	#sections-builder .section-remove,
	#sections-builder .section-add{
	...
	#sections-builder .sections-builder-body{
	...
	#sections-builder .sections-builder-body > header{
		display: flex;
		padding:0.7em;
		justify-content: space-between;
		border-bottom:1px dashed #999;
	}	
	#sections-builder .sections-grider{
		display: flex;
	...
	#sections-builder .sections-grider > *:last-of-type{
		border-right: none;
	}
</style>